  ...
  return (
    <div>
      <div className="flex flex-col w-full bg-[url('/backgroundLogo.svg')] items-center justify-start bg-cover bg-no-repeat bg-right gap-2">
        <div className="flex flex-col gap-6 w-full py-3 md:py-5 bg-[url('/personal.png')] bg-size-[60%] md:bg-size-[38%] bg-no-repeat bg-bottom-right">
          <div className="flex flex-col w-60 md:w-200 font-bold text-base md:text-3xl lg:text-5xl 2xl:text-7xl">
            <span>
              Potencialize seus treinos e transforme o acompanhamento dos seus
              alunos
            </span>
          </div>
          <div className="flex flex-col w-48 md:w-200 italic text-xs md:text-xl lg:text-2xl 2xl:text-4xl">
            <span>
